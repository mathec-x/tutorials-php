...
<body>
  ...
  <div class="w3-padding-128 w3-text-grey">
    <div class="w3-container">
      ...
      <button name="btnVisualizar" class="w3-button w3-center w3-block w3-margin w3-blue w3-cell w3-roundlarge" style="width: 10%;"></button>
      </button>
    </div>
  </div>
  ...
  <form action="../Controller/Navegacao.php" method="post" class="w3-container w3-light-grey w3-textblue w3-margin w3-center" style="width: 30%;">
    <div class="w3-row w3-section">
      <div>
        <button name="btnVoltar" class="w3-button w3-center w3-block w3-margin w3-blue w3-cell w3-roundlarge" style="width: 90%;">Voltar</button>
      </div>
    </div>
  </form>
  </div>

...
<body class="w3-light-grey">
  ...
  <nav class="w3-sidebar w3-bar-block w3-center w3-blue ">
    ...
    <a href="#experienciaProfissional" class="w3-bar-item w3-button w3-block n w3-cell w3-hover-light-grey w3-hover-text-cyan w3-text-light-grey">
      <i class="fa fa-briefcase w3-xxlarge"></i>
      <p>Experiência Profissional</p>
    </a>

    <a href="#outraFormacao" class="w3-bar-item w3-button w3-center w3-block n w3-cell w3-hover-light-grey w3-hover-text-cyan w3-text-light-grey">
      <i class="fa fa-address-book-o w3-center w3-xxlarge"></i>
      <p>Outra Formação</p>
    </a>
  </nav>
  ...
  <div class="w3-padding-128 w3-content w3-text-grey" id="dPessoais">
    ...
    <form action="../Controller/Navegacao.php" method="post" class=" w3-row w3-light-grey w3-text-blue w3-margin" style="width: 70%">
      <div class="w3-row w3-center">
        ...
        <div class="w3-res" style="width: 50%">
          Data Final
        </div>
      </div>
      ...
      <div class="w3-row w3-section">
        ...
        <div class="w3-row w3-section w3-rest" style="width: 50%">
    ...
    <form action="../Controller/Navegacao.php" method="post" class=" w3-row w3-light-grey w3-text-blue w3-margin" style="width: 95%;">
      <div class="w3-row w3-center">
    ...
    <div class="w3-padding-128 w3-center w3-text-grey" id="oFormacoes">
    ...
    <form action="../Controller/Navegacao.php" method="post" class=" w3-row w3-light-grey w3-text-blue w3-margin" style="width: 100%;">
      ...
      <div class="w3-row w3-section">
        ...
        <div>
          ...
          <div class="w3-row w3-section">
            <div class="w3-center" style="width: 50%">
              <button name="btnAddOF" class="w3-button w3-block w3-blue w3-cell w3-round-large" style="width: 25%;">
                <i class="w3-xxlarge fa fa-user-plus"></i>
              </button>
            </div>
          </div>
